                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::NUM, "txsaccepted", "The number of received transaction messages which have been accepted"},
                            {RPCResult::Type::NUM, "txsrejected", "The number of received transaction messages which have been rejected"},
                            {RPCResult::Type::NUM, "txspendingorphan", "The number of received transaction messages which are currently orphaned"},
                            {RPCResult::Type::NUM, "txsnotprocessed", "The number of received transaction messages which were not processed by the node"},
